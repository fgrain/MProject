...
public class OrbitCamera : MonoBehaviour {
    ...
    private void Start()
    {
		PlayerController.PlayerInputAction.Player.Look.performed += Look_performed;
	}
    private void Look_performed(InputAction.CallbackContext value)
    {
        if (Mouse.current.rightButton.isPressed)
		{
			Vector2 cameraInput = value.ReadValue<Vector2>();
			cameraInput = new Vector2(-cameraInput.y, -cameraInput.x);
			ManualRotation(cameraInput);
		}
	}
	...
	bool ManualRotation (Vector2 input) {
